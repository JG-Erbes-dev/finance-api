...
#     historical_risk = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True, verbose_name='Risco Histórico')
#     historical_return = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True, verbose_name='Risco Histórico')
